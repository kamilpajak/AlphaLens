...
- **Rebalance** — the act of recomputing scores at an `asof` and updating portfolio holdings; in v3-v5 the rebalance stride is 5 trading days with a 20-day holding period, producing 75% overlap (4-tranche).
