...
from alphalens_research.thematic.argumentation.renderer import render_day_bundle, render_markdown
...
def _enrich_facts_with_earnings(facts: dict, asof: dt.date) -> dict:
    ...
    from alphalens_research.thematic.sources.earnings_calendar import fetch_next_earnings
...
def _build_clients(api_key: str | None):
    ...
    from alphalens_research.data.alt_data.gemini_client import (
        GeminiClient,
