...
the module now delegates to :mod:`alphalens_research.data.fundamentals.sic_index`
...
from alphalens_research.data.fundamentals.sic_index import (
...
__all__ = ["get_industry_id", "industry_label", "iter_industry_peers"]
