...
from alphalens_research.thematic.screening import (
    catalyst_signals,
    fcff_signal,
    insider_signal,
    magic_formula,
...
def _yfinance_mcap_for_gate(ticker: str, asof: dt.date) -> float | None:
    ...
    Thin wrapper around
    :func:`alphalens_research.thematic.verification.mcap_filter.fetch_mcap` so the
    ...
    """
    from alphalens_research.thematic.verification.mcap_filter import fetch_mcap
