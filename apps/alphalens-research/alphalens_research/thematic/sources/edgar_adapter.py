...
Wraps the existing ``alphalens_research.watchdog.sources.edgar.SECEdgarSource`` so that
...
from alphalens_research.thematic.config.universe import load_input_universe
