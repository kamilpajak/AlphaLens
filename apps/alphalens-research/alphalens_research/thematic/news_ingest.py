...
EDGAR signal lives in ``alphalens_research/watchdog/`` Layer 1 (dedicated 8-K parsers).
...
from alphalens_research.thematic import text_similarity
from alphalens_research.thematic.sources import gdelt, polygon_news, rss
from alphalens_research.thematic.sources.schema import NEWS_COLUMNS, empty_news_frame
