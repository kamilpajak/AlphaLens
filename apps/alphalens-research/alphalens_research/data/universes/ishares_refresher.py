...
Generic refresher analogous to ``alphalens_research.data.alt_data.iwm_refresher`` but
...
from alphalens_research.data.alt_data.iwm_refresher import parse_ishares_csv
...
def refresh_ishares_snapshot(
    *,
    ...
    :func:`alphalens_research.data.universes.sp1500_pit._load_for_date`.
