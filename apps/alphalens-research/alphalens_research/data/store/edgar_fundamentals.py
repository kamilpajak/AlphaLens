...
fetched on demand via :class:`alphalens_research.data.alt_data.sec_edgar_client.SecEdgarClient`
...
``alphalens_research/thematic/screening/{fcff_signal,valuation_signal,magic_formula}.py``
...
from alphalens_research.data.fundamentals.edgar_companyfacts import _pit_filter
from alphalens_research.data.fundamentals.ttm_aggregator import (
...
class EdgarFundamentalsStore:
    ...
    with_prices
        ...
        :mod:`alphalens_research.thematic.verification.mcap_filter`. Today this flag
    ...
    def _fetch_shares_yf(self, ticker: str, asof: date) -> float | None:
        ...
        :mod:`alphalens_research.thematic.verification.mcap_filter` so live brief
