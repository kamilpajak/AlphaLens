...
:mod:`alphalens_research.thematic.screening.sector_peers` after PR #161 removed the
``simfin>=1.0.2`` dependency but missed this independent SimFin consumer
(issue #169).

Source of truth: a small parquet shipped at
``alphalens_research/data/fundamentals/sic_index.parquet`` with columns
...
canonical :class:`alphalens_research.data.alt_data.sec_edgar_client.SecEdgarClient`,
