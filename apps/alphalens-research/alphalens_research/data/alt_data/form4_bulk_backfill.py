...
:data:`alphalens_research.data.store.form4_pit.FORM4_SCHEMA_COLUMNS`.
...
from alphalens_research.data.store.form4_pit import FORM4_SCHEMA_COLUMNS, PARTITION_KEY
