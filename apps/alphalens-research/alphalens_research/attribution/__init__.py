...
Consumes engine output (`alphalens_research.backtest.engine.BacktestReport` and the
...
Layer 5 may import `alphalens_research.backtest.engine.BacktestReport` (the engine's
