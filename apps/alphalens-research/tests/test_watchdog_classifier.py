...
def _event(form_type, ticker="AAPL", raw_data=None, accession="ACC-1"):
    from alphalens_pipeline.watchdog.types import Event
...
class TestForm4Severity(unittest.TestCase):
    ...
    def test_form4_default_low_when_action_unknown(self):
        from alphalens_pipeline.watchdog.classifier import Severity, SignalClassifier
...
class TestActionMatrix(unittest.TestCase):
    def test_classify_returns_severity_relevance_action(self):
        from alphalens_pipeline.watchdog.classifier import ClassifiedEvent, SignalClassifier
        from alphalens_pipeline.watchdog.types import FormType
    ...
    def test_action_matrix_covers_all_cells(self):
        ...
        from alphalens_pipeline.watchdog.classifier import Action, Severity, SignalClassifier
