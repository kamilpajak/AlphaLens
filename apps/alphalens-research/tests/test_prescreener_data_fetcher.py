...
class TestBatchDataFetcher(unittest.TestCase):
    ...
    @patch("alphalens_research.screeners.prescreener.data_fetcher.yf.download")
    def test_fetch_prices_returns_dict_of_dataframes(self, mock_download):
        from alphalens_research.screeners.prescreener.data_fetcher import BatchDataFetcher
    ...
    @patch("alphalens_research.screeners.prescreener.data_fetcher.yf.Ticker")
