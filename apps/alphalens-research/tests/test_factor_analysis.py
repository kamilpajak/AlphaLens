"""Tests for alphalens_research.attribution.factor_analysis — Carhart 4F + HAC + rolling + industry."""
...
class TestRollingRegression(unittest.TestCase):
    def test_returns_timeseries_of_betas_plus_alpha(self):
        from alphalens_research.attribution.factor_analysis import run_rolling_regression
...
class TestFormatSummary(unittest.TestCase):
    def test_format_contains_spec_alpha_and_all_betas(self):
        from alphalens_research.attribution.factor_analysis import AlphaResult, format_alpha_summary
...
class TestBootstrapCarhartAlphaCi(unittest.TestCase):
    ...
    def test_zero_alpha_strategy_ci_brackets_zero(self):
        from alphalens_research.attribution.factor_analysis import bootstrap_carhart_alpha_ci
...
class TestFitCarhart4FInvestedOnly(unittest.TestCase):
    ...
    def test_nan_days_excluded(self) -> None:
        ...
        from alphalens_research.attribution.factor_analysis import fit_carhart_4f_invested_only
