...
class TestEntryDay(unittest.TestCase):
    ...
    def test_premarket_event_enters_at_close_of_report_day(self) -> None:
        from alphalens_research.screeners.event_drift.pead_pss_scorer import compute_entry_day
...
class TestExitDay(unittest.TestCase):
    def test_exit_is_entry_plus_hold_days_trading_days(self) -> None:
        ...
        from alphalens_research.screeners.event_drift.pead_pss_scorer import compute_exit_day
...
class TestDailyWeightsTiming(unittest.TestCase):
    ...
    def test_premarket_event_at_t_has_zero_weight_on_t_first_active_is_tplus1(
        ...
        from alphalens_research.screeners.event_drift.pead_pss_scorer import build_daily_weights
...
class TestPortfolioReturnsWarnings(unittest.TestCase):
    def test_warns_on_missing_ticker_in_returns(self) -> None:
        ...
        with self.assertLogs(
            "alphalens_research.screeners.event_drift.pead_pss_scorer", level="WARNING"
        ) as ctx:
