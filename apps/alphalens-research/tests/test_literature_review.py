"""Tests for `alphalens_research.literature_review` module.
...
class TestTriggerDetection(unittest.TestCase):
    def test_no_trigger_when_response_says_none(self):
        from alphalens_research.literature_review.runner import has_reactivation_trigger
...
class TestPerplexityClient(unittest.TestCase):
    @patch("alphalens_research.literature_review.perplexity_client.requests.post")
    def test_ask_posts_to_chat_completions(self, mock_post):
        from alphalens_research.literature_review.perplexity_client import PerplexityClient
...
class TestPrompts(unittest.TestCase):
    def test_monthly_prompt_mentions_4_topic_baskets(self):
        from alphalens_research.literature_review.prompts import build_monthly_prompt
    ...
    def test_weekly_prompt_is_shorter_and_mentions_top_3(self):
        from alphalens_research.literature_review.prompts import build_weekly_prompt

        monthly = __import__(
            "alphalens_research.literature_review.prompts", fromlist=["build_monthly_prompt"]
...
class TestRunnerOrchestration(unittest.TestCase):
    def setUp(self):
        ...
        self.client_patcher = patch("alphalens_research.literature_review.runner.PerplexityClient")
        self.telegram_patcher = patch("alphalens_research.literature_review.runner.TelegramHandler")
    ...
    def test_run_monthly_writes_markdown_to_correct_path(self):
        ...
        from alphalens_research.literature_review.runner import run_monthly
    ...
    def test_run_weekly_uses_weekly_subdir(self):
        ...
        from alphalens_research.literature_review.runner import run_weekly
...
class TestPeriodFormat(unittest.TestCase):
    def test_default_monthly_period_is_yyyy_mm(self):
        ...
        from alphalens_research.literature_review.runner import default_period
...
class TestLayerStatus(unittest.TestCase):
    def test_literature_review_module_declares_active_status(self):
        import alphalens_research.literature_review as mod
