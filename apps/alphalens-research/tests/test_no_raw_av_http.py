...
:class:`alphalens_pipeline.data.alt_data.alphavantage_client.AlphaVantageClient`.
...
CANONICAL_CLIENT_REL = (
    "apps/alphalens-pipeline/alphalens_pipeline/data/alt_data/alphavantage_client.py"
)
    ...
    def test_no_shadow_av_http_outside_canonical_client(self):
        ...
        if offenders:
            ...
            self.fail(
                ...
                "alphalens_pipeline.data.alt_data.alphavantage_client (use\n"
