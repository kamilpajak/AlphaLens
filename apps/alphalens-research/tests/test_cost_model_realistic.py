...
class TestCalibrateK(unittest.TestCase):
    def test_recovers_known_k(self):
        ...
        from alphalens_research.attribution.cost_model import RealisticCostModel, calibrate_k
    ...
    def test_calibrate_empty_raises(self):
        from alphalens_research.attribution.cost_model import calibrate_k
...
class TestBackwardCompatibility(unittest.TestCase):
    def test_existing_cost_model_unchanged(self):
        ...
        from alphalens_research.attribution.cost_model import _PROFILE_BPS, CostModel
