"""Tests for alphalens_research.data.factors — FF5 / UMD / Industry12 loaders."""
...
class TestLoadFF5Daily(unittest.TestCase):
    def test_returns_six_expected_columns(self):
        from alphalens_research.data.factors import load_ff5_daily
...
class TestLoadUMDDaily(unittest.TestCase):
    def test_returns_single_mom_column(self):
        from alphalens_research.data.factors import load_umd_daily
...
class TestLoadIndustry12Daily(unittest.TestCase):
    def test_returns_12_industry_columns_value_weighted(self):
        from alphalens_research.data.factors import load_industry12_daily
...
class TestRealFactorFiles(unittest.TestCase):
    ...
    def test_ff5_smoke(self):
        from alphalens_research.data.factors import DEFAULT_FF5_PATH, load_ff5_daily
    ...
    def test_umd_smoke(self):
        from alphalens_research.data.factors import DEFAULT_UMD_PATH, load_umd_daily
    ...
    def test_industry12_smoke(self):
        from alphalens_research.data.factors import (
