...
from alphalens_research.backtest.top_decile_portfolio import (  # noqa: E402
...
def _score_v9d_residual(
    ...
    from alphalens_research.screeners.options_implied.features import build_feature_frame
