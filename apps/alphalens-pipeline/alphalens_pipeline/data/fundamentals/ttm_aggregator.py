...
Generalises ``_ttm_net_income`` from :mod:`alphalens_pipeline.data.fundamentals.edgar_companyfacts`
...
existing :func:`alphalens_pipeline.data.fundamentals.edgar_companyfacts._pit_filter`.
"""
