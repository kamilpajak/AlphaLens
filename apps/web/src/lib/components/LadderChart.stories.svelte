...
<!-- EMPTY STOP: the stop was crossed but closed nothing — an earlier TP already
     sold the whole held position. The SL renders as a dimmed circle
     (SL_TOUCHED), not a solid red arrow that would overstate a loss that
     never happened economically. -->
