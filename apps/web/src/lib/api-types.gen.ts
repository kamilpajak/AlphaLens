...
export interface components {
    schemas: {
        ...
        EdgeSummary: {
            ...
            n_terminal: number;
            n_matured: number;
            /** @description Terminal rows that carry no benchmark and never will (the corporate-action quarantine, SPLIT_INVALIDATED): n_terminal == n_matured + n_quarantined + retriable gaps. The completeness banner divides by n_terminal - n_quarantined. */
        ...
        /**
         * @description The WHAT-IF panel — display-only, IN-SAMPLE counterfactual exit lenses.
         *
