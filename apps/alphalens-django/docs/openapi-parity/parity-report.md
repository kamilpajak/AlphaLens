...
- Response fields new in Django: `atr_penalty, brief_error_kind, brief_status, brief_template_facts, brief_template_id, brief_trade_setup, expert_assessments, gate_verdict_json, insider_signal_version, market_state, market_state_atr_pct, market_state_atr_pct_q, market_state_config_version, market_state_dist200, market_state_squeeze_on, market_state_vix, market_state_vix_decile, peer_cohort_level, scorer_config_version, selection_score`

### `/v1/days/{date}`

**GET**

- Response fields new in Django: `meta`
