# v7 Phase B holdout reveal — FAIL (αt=+2.16 < 2.86 naive Bonferroni)
...
| Carhart-4F α (net, ann) | +212.25% |
| α t-stat (HAC=5) | **+2.16** |
| Excess vs MDY (gross, ann) | +66.58% |
...
| --- | ---: |
| Sharpe (gross) | -1.00 |
| Sharpe (net 60bps RT) | -1.00 |
| Carhart-4F α (gross, ann) | -921.28% |
| α t-stat (HAC=5) | -2.78 |

## Lasso fit (standardized features, train period)

- α (penalty): 0.0008883
- n_train: 167583, CV-MSE: 0.07892
- nonzero coefs: 5 / 7 (options-feature subset: 3 / 4)

| Feature | Coef (standardized) |
| --- | ---: |
| ivp30 | +0.003614 |
| ivx30 | +0.01168 |
| ivx180_minus_ivx30 | +0 |
| ivx30_over_hv20 | -0.006048 |
| reversal_1m | +0.0006714 |
| momentum_6m | -0 |
| rv_30d | +0.004925 |
