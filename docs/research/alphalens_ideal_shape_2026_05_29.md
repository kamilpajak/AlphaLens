...
4. **Feedback ledger v2 — outcome join** (Track A v2) — links each decision to its paper-trade outcome [✅ PR-1 schema + join plumbing #351, ✅ PR-2 VIX cache #354, ✅ PR-3 `shadow_return` + `realized_return` #356 — all SHIPPED; remaining: nightly VPS timer wiring + PR-4 execution-mode gating at ≥50 decisions]
