...
**Wall total:** 345.3 min (max single phase 345.0 min — parallel)

## Gates (R2000 primary, pre-reg lock)

| Gate | Metric | Threshold | Result |
|---|---|---|---|
| G1 pooled αt | +2.710 | ≥ 3.1237 (Bonferroni n=27) | ❌ |
...
- Pre-reg ledger: `docs/research/preregistration/ledger.json` entry `insider_form4_opportunistic_2026_05_05`
