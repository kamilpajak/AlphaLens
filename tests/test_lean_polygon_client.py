...
class TestGroupedDaily(unittest.TestCase):
    ...
    def test_parses_rows_into_grouped_bars(self):
        self.session.get.return_value = _response(
            ...
            {
                "results": [
                    {"T": "AAPL", "o": 100.0, "h": 102.0, "l": 99.0, "c": 101.0, "v": 12345, "t": 1700000000000},
                    {"T": "MSFT", "o": 200.0, "h": 205.0, "l": 199.0, "c": 204.0, "v": 6789, "t": 1700000000000},
                ]
            },
        )
    ...
    def test_raises_on_4xx(self):
        from alphalens.lean_screener.polygon_client import PolygonError
...
class TestTickerRange(unittest.TestCase):
    ...
    def test_parses_ticker_range_results(self):
        self.session.get.return_value = _response(
            ...
            {
                "results": [
                    {"o": 100.0, "h": 102.0, "l": 99.0, "c": 101.0, "v": 1000, "t": 1713484800000},
                    {"o": 101.0, "h": 103.0, "l": 100.0, "c": 102.5, "v": 1100, "t": 1713571200000},
                ],
            },
        )
