...
class TestFormatAndParse(unittest.TestCase):
    def test_round_trip_preserves_bar(self):
        from alphalens.archive.screeners.lean.lean_csv_writer import format_bar, parse_bar
    ...
    def test_format_uses_lean_scaled_prices(self):
        from alphalens.archive.screeners.lean.lean_csv_writer import format_bar
    ...
    def test_parse_rejects_malformed(self):
        from alphalens.archive.screeners.lean.lean_csv_writer import parse_bar
