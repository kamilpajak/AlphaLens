...
class TestVerdictCommand(unittest.TestCase):
    ...
    def test_v9d_empty_ledger_short_circuits(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                patch(
                    "alphalens.paper_trade.ledger.default_ledger_path",
                    return_value=empty_path,
                ),
                patch(
                    "alphalens.paper_trade.verdict.default_verdict_path",
    ...
    def test_v9d_populated_ledger_writes_verdict_markdown(self):
        from alphalens.paper_trade.ledger import LEDGER_COLUMNS
        from alphalens.paper_trade.verdict import DecisionRuleResult
        from alphalens_cli.commands.paper_trade import paper_trade_app
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                ...
                patch(
                    "alphalens.paper_trade.verdict.evaluate_decision_rule",
...
class TestScoreCommand(unittest.TestCase):
    ...
    def test_first_ever_score_writes_state_skips_ledger(self):
        ...
        from alphalens.paper_trade.scorer_v9d import ScoringResult
        from alphalens_cli.commands.paper_trade import paper_trade_app
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                ...
                patch(
                    "alphalens.paper_trade.state.default_state_path",
                    return_value=state_path,
                ),
                patch(
                    "alphalens.paper_trade.scorer_v9d.make_smd_loader",
                    return_value=object(),
                ),
                patch(
                    "alphalens.paper_trade.scorer_v9d.latest_trading_asof",
                    return_value=date(2026, 5, 4),
                ),
                patch(
                    "alphalens.paper_trade.scorer_v9d.pit_union",
                    return_value=["AAA", "BBB", "CCC", "DDD"],
                ),
                patch(
                    "alphalens.paper_trade.scorer_v9d.score_top_decile",
    ...
    def test_subsequent_score_appends_ledger_and_updates_state(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                ...
                patch(
                    "alphalens.paper_trade.scorer_v9d.compute_realized_return",
                    return_value=(0.012, 2),
                ),
                patch(
                    "alphalens.paper_trade.scorer_v9d.benchmark_return",
                    return_value=0.005,
                ),
            ):
                result = self.runner.invoke(
