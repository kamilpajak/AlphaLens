...
def _run_baseline_pipeline() -> tuple[pd.DataFrame, pd.Series, dict[str, float]]:
    ...
    from alphalens.attribution.cost_model import RealisticCostModel  # noqa: F401
    from alphalens.backtest.engine import BacktestEngine
    from alphalens.data.alt_data.pit_universe_loader import load_universe_union
    ...
    from alphalens.data.store.form4_pit import Form4PITStore
