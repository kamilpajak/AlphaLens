...
class TestLeanConfig(unittest.TestCase):
    ...
    def test_paths_are_absolute(self):
        from alphalens.lean_screener.config import (
            DATA_DIR,
            LEAN_PROJECT_DIR,
            RESULTS_DIR,
            UNIVERSE_PATH,
    ...
    def test_universe_yaml_ships_with_package(self):
        from alphalens.lean_screener.config import UNIVERSE_PATH
...
class TestUniverseLoader(unittest.TestCase):
    def test_loads_multiple_sectors(self):
        from alphalens.lean_screener.universe import load_universe
...
class TestFlattenUniverse(unittest.TestCase):
    def test_dedup_across_sectors(self):
        from alphalens.lean_screener.universe import flatten_universe
...
class TestDelistedLoader(unittest.TestCase):
    def test_load_from_custom_path(self):
        from alphalens.lean_screener.universe import load_delisted
    ...
    def test_production_file_loads(self):
        ...
        from alphalens.lean_screener.config import DELISTED_UNIVERSE_PATH
        from alphalens.lean_screener.universe import load_delisted
    ...
    def test_filter_on_or_after(self):
        from alphalens.lean_screener.universe import delisted_tickers_on_or_after
...
class TestBenchmarksConfig(unittest.TestCase):
    def test_benchmarks_constant_exists(self):
        from alphalens.lean_screener.config import BENCHMARKS
