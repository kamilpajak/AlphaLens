...
class TestWorkerLock(unittest.TestCase):
    ...
    def test_acquire_releases_context_manager(self):
        from alphalens.watchdog.lock import worker_lock
    ...
    def test_second_acquire_in_same_process_raises(self):
        from alphalens.watchdog.lock import WorkerLockBusy, worker_lock
    ...
    def test_second_acquire_in_different_process_raises(self):
        ...
        code = textwrap.dedent(f"""
            ...
            from pathlib import Path
            from alphalens.watchdog.lock import worker_lock, WorkerLockBusy
            try:
    ...
    def test_default_lock_path(self):
        from alphalens.watchdog.lock import default_worker_lock_path
