...
class TestRateOfChange(unittest.TestCase):
    def test_positive_return(self):
        from alphalens.screeners.lean.lean_project.features import rate_of_change
...
class TestSMA(unittest.TestCase):
    def test_average_of_last_window(self):
        from alphalens.screeners.lean.lean_project.features import sma
...
class TestVolumeSurprise(unittest.TestCase):
    def test_above_average(self):
        from alphalens.screeners.lean.lean_project.features import volume_surprise
...
class TestDistanceToHigh(unittest.TestCase):
    def test_at_high_returns_zero(self):
        from alphalens.screeners.lean.lean_project.features import distance_to_high
...
class TestBreakout(unittest.TestCase):
    def test_true_when_above_high_with_volume(self):
        from alphalens.screeners.lean.lean_project.features import breakout
...
class TestDollarVolumeAverage(unittest.TestCase):
    def test_constant_case(self):
        from alphalens.screeners.lean.lean_project.features import (
...
class TestZScore(unittest.TestCase):
    def test_standard_normal_distribution(self):
        from alphalens.screeners.lean.lean_project.features import z_score
