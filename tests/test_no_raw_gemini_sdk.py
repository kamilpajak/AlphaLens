...
the repo through
:class:`alphalens.data.alt_data.gemini_client.GeminiClient`. Five live
...
in any file under ``alphalens/`` (excluding ``alphalens/archive/`` — the
...
EXEMPT_PATH_PREFIXES = (
    "alphalens/data/alt_data/gemini_client.py",
    "alphalens/archive/",
)
    ...
    def test_no_shadow_gemini_sdk_outside_canonical_client(self):
        ...
        if offenders:
            ...
            self.fail(
                ...
                "alphalens.data.alt_data.gemini_client (use\n"
