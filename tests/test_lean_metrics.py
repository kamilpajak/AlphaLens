...
class TestSharpe(unittest.TestCase):
    def test_constant_return_is_zero_sharpe(self):
        from alphalens.lean_screener.backtest.metrics import sharpe
...
class TestRankIC(unittest.TestCase):
    def test_perfect_rank_correlation(self):
        from alphalens.lean_screener.backtest.metrics import rank_ic
...
class TestRankICTStat(unittest.TestCase):
    def test_zero_mean_returns_zero(self):
        from alphalens.lean_screener.backtest.metrics import rank_ic_tstat
...
class TestRankICRolling(unittest.TestCase):
    def test_rolling_matches_expected(self):
        from alphalens.lean_screener.backtest.metrics import rank_ic_rolling
...
class TestRankICPositivePct(unittest.TestCase):
    def test_all_positive(self):
        from alphalens.lean_screener.backtest.metrics import rank_ic_positive_pct
...
class TestDecileSpread(unittest.TestCase):
    def test_positive_alignment(self):
        from alphalens.lean_screener.backtest.metrics import decile_spread
...
class TestHitRate(unittest.TestCase):
    def test_beats_every_day(self):
        from alphalens.lean_screener.backtest.metrics import hit_rate
...
class TestTurnover(unittest.TestCase):
    def test_full_turnover(self):
        from alphalens.lean_screener.backtest.metrics import turnover_pct
...
class TestMaxDrawdown(unittest.TestCase):
    def test_monotonic_up_no_drawdown(self):
        from alphalens.lean_screener.backtest.metrics import max_drawdown
...
class TestCalmarRatio(unittest.TestCase):
    def test_positive_calmar_when_profitable_with_dd(self):
        from alphalens.lean_screener.backtest.metrics import calmar_ratio
...
class TestConcentration(unittest.TestCase):
    def test_equal_weight_30_names_top5_is_167pct(self):
        from alphalens.lean_screener.backtest.metrics import concentration_top_k
...
class TestSummarisePortfolio(unittest.TestCase):
    def test_returns_sane_summary(self):
        from alphalens.lean_screener.backtest.metrics import summarise_portfolio
