...
1. Implement the three callables (scorer / universe / refresh) somewhere
   in ``alphalens.paper_trade.*`` exposing the same call signatures as
   the v9D originals.
...
REGISTRY: dict[str, Strategy] = {
    "v9d": Strategy(
        ...
        scorer_callable_path="alphalens.paper_trade.scorer_v9d:score_top_decile",
        universe_callable_path="alphalens.paper_trade.scorer_v9d:pit_union",
        refresh_callable_path="alphalens.paper_trade.scorer_v9d:incremental_refresh_smd",
    ),
}
