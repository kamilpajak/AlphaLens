...
__closed_evidence__: dict[str, str] = {
    "carhart_4f_hac": "docs/backtest/layer2d_revalidation.md",
    "sanity_checks_4gate": "N/A: weekly Form-4 scoring, not rotation overlay",
    "walk_forward_oos": "docs/backtest/layer2d_revalidation.md",
    "multiple_testing_correction": "docs/backtest/layer2d_revalidation.md",
    "cost_drag": "docs/backtest/layer2d_revalidation.md",
    "bootstrap_ci": "docs/backtest/layer2d_revalidation.md",
